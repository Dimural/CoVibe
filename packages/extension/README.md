...
Telemetry is off by default. When enabled, only anonymous, aggregated events are sent — never code, file paths, or personal data. See [PRIVACY.md](../../PRIVACY.md) for full details.
